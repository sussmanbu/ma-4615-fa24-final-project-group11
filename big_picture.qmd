...
In 2022, the [World Health Organization (WHO)](https://www.who.int/news-room/fact-sheets/detail/mental-disorders#:~:text=In%202019%2C%201%20in%20every,of%20the%20COVID%2D19%20pandemic.) reported that one in eight people—approximately 970 million individuals worldwide—were living with a mental disorder. In the United States, the proportion is even higher: more than one in five adults, or 59.3 million people (23.1% of the adult population), according to the [National Institute of Mental Health (NIHM)](https://www.nimh.nih.gov/health/statistics/mental-illness).

Numerous factors contribute to this issue, including physical mobility, physical activity, life experiences, substance use, and biological influences. While these variables significantly impact well-being, most remain beyond an individual's control. Moreover, access to healthcare is a critical factor that cannot be overlooked. Many elements affect mental health, but here, we will focus on three key factors.
...
p3 <- create_map(map_data, "mean_total_mh", "Mental Health Score")
