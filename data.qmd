...
The data included a wide variety of variables from veteran status to the impacts of natural disasters. The cleaned data for the Household Pulse Survey is called `data_clean.csv`. However, we focused on the following variables in our analysis:
